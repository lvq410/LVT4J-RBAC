 ...
 */
public class LruLinkedHashMapProductAuthCacheTest {

    LruLinkedHashMapProductAuthCache cache;
    ...
    @Test
    public void testCap2() throws Exception {
        ...
        cache = new LruLinkedHashMapProductAuthCache(2);
        ...
        cache.close();
        cache = new LruLinkedHashMapProductAuthCache(10);
        cache.loader = id->{UserAuth ua = new UserAuth();ua.userId=id;return ua;};
        ...
        assertEquals(90, cache.getHitCount());
        ...
        assertEquals(10, cache.getCapacity());
        assertEquals(9, cache.getSize());
        assertEquals(91, cache.getHitCount());
        assertEquals(10, cache.getMissCount());
        ...
        assertEquals(10, cache.getCapacity());
        assertEquals(9, cache.getSize());
        assertEquals(92, cache.getHitCount());
        assertEquals(10, cache.getMissCount());
        
        assertEquals("2", cache.getOrLoad("2").userId);
        assertEquals(10, cache.getCapacity());
        assertEquals(9, cache.getSize());
        assertEquals(93, cache.getHitCount());
        assertEquals(10, cache.getMissCount());
